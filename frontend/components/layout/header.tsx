...
export function Header({ onMenuClick }: HeaderProps) {
  return (
    <header className="h-14 flex items-center gap-3 px-4 md:px-6 flex-shrink-0 border-b border-white/[0.05] sticky top-0 z-30"
      style={{ background: "rgba(5,5,12,0.8)", backdropFilter: "blur(20px) saturate(1.5)" }}>

      <button onClick={onMenuClick} className="lg:hidden p-2 text-slate-500 hover:text-white transition-colors rounded-lg hover:bg-white/5">
